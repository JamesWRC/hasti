  ...
  return (
    ...
    <>
      ...
      <div className='transition-all duration-700 mx-auto xl:max-w-5xl 2xl:max-w-6xl 4xl:max-w-8xl xl:-mt-24'>
        ...
        <div className='bg-white rounded-2xl px-4 pt-6 md:px-36 md:pt-3 lg:px-40 lg:pt-4 mx-auto'> 
          <div className='mt-1 text-4xl font-extrabold text-gray-900 sm:text-5xl lg:text-6xl'>{params.name}asdasdasdsa 
