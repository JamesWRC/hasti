...
const navigation = [
    ...
    { name: 'hdsasashsd', href: '/integrations', icon: SquaresPlusIcon},
    { name: 'fds', href: '/integrations', icon: SquaresPlusIcon},
    { name: 'dddd', href: '/integrations', icon: SquaresPlusIcon},
    { name: 'bbbb', href: '/integrations', icon: SquaresPlusIcon},
